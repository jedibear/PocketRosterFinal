...
#define mensTrackBackgroundPhotoImagePath [[NSBundle mainBundle]pathForResource:@"MTrackSchedulePhoto" ofType:@"jpg"]
...
#define fieldHockeyBackgroundImagePath [[NSBundle mainBundle]pathForResource:@"WFeildHockey" ofType:@"jpg"]
#define womensVolleyballBackgroundImagePath [[NSBundle mainBundle]pathForResource:@"WVolleyball" ofType:@"jpg"]
...
#define womensVolleyballBackgroundScheduleImagePath [[NSBundle mainBundle]pathForResource:@"WVolleyballSchedule" ofType:@"jpg"]
...
#define womensVolleyballBackgroundPhotoImagePath [[NSBundle mainBundle]pathForResource:@"WVolleyballPhoto" ofType:@"jpg"]
...
#define womensSailingBackgroundPhotoImagePath [[NSBundle mainBundle]pathForResource:@"WSailingPhoto" ofType:@"png"]
