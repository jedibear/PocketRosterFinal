...
- (void)viewDidLoad
{
    ...
    [self.teams addObject:@"General"];
    [self.teams addObject:@"Football"];
    [self.teams addObject:@"Mens Swimming and Diving"];
    [self.teams addObject:@"Mens Lacrosse"];
    [self.teams addObject:@"Baseball"];
...
{
    static NSString *CellIdentifier = @"RSSHomeCell";
    RSSHomeCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    // Configure the cell...
    cell.teamName.text = [self.teams objectAtIndex:indexPath.row];
